...
import { getPromptTags, getRelatedPrompts } from "@/lib/data-utils"
...
export default async function PromptDetailPage({ params }: PromptDetailPageProps) {
    ...
    const [allPrompts, allTags] = await Promise.all([
        JSONFileDB.getAllPrompts(),
        JSONFileDB.getAllTags(),
    ])
    const prompt = allPrompts.find(p => p.id === id && p.status === "published")
