...
import type { Prompt, SortBy, TimePeriod } from "@/lib/types";
import { getPublishedPrompts, sortPrompts } from "@/lib/data-utils";
import { getPeriodStats, isSupabaseConfigured } from "@/lib/supabase";
import { deletePromptMedia, deleteReplacedPromptMedia } from "@/lib/media-cleanup";
...
export async function GET(request: Request) {
    ...
    const allPrompts = await JSONFileDB.getAllPrompts();
